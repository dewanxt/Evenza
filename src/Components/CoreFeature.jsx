...
const CoreFeature = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1035] relative overflow-hidden font-sans text-white py-20 px-4">
      ...
      {/* --- Dark Gradient Overlay (Ensures text readability over the image) --- */}
      <div className="absolute inset-0 bg-linear-to-b from-[#1a1035]/80 to-[#120b26]/95 z-0"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <SecHead 
          ...
          className="text-center mx-auto text-5xl flex flex-col items-center justify-center mb-16 w-160"
        />
